...
<execution_context>
@/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/workflows/docs-update.md end-to-end.
