...
<execution_context>
@/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
