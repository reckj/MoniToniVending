...
- **Global scope**: `/home/admin/_DEV/MoniToniVending/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/admin/_DEV/MoniToniVending/.claude/notes/`)
...
2. Glob `/home/admin/_DEV/MoniToniVending/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/admin/_DEV/MoniToniVending/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/admin/_DEV/MoniToniVending/.claude/notes/` — works in any directory
