...
```
Task(
  prompt="Read /home/admin/_DEV/MoniToniVending/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/templates/SECURITY.md`
