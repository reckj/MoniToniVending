...
- @/home/admin/_DEV/MoniToniVending/.claude/agents/gsd-user-profiler.md (profiler agent definition)
...
```bash
cp "/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/USER-PROFILE.md" "/home/admin/_DEV/MoniToniVending/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/home/admin/_DEV/MoniToniVending/.claude/USER-PROFILE.backup.md"
```
