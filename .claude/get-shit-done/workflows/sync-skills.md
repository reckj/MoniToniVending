...
INSTALL_JS_GLOBAL="/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/admin/_DEV/MoniToniVending/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
