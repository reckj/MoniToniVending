...
Reference full template: `/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/templates/state.md`.
