...
<reference>
@/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/admin/_DEV/MoniToniVending/.claude/get-shit-done/references/user-profiling.md` to load:
