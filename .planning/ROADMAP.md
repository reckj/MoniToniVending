...
- [x] 02.1-03-PLAN.md — UI screens: relay (dual-section), motor (relay_core), sensor (method indicator)
- [x] 02.1-04-PLAN.md — Caller migration: customer screen, app, telemetry, maintenance, main
